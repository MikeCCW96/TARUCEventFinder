...
$mysql_qry = "SELECT * FROM referral r, eventregistration er WHERE r.referTo = '$studentId' AND er.studentId = '$studentId' AND er.timeTableId = r.timeTableId AND er.Status = 'Active';";
...
$dbEventEndTime = array(); 
	...
	while($row = mysqli_fetch_array($result)){
		$mysql_qry4 = "SELECT * FROM StudentSimple WHERE StudentID = '".$row['referBy']."';";
